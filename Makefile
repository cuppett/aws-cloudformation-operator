...
# quay.io/cuppett/cloudformation-controller-bundle:$VERSION and quay.io/cuppett/cloudformation-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/cuppett/aws-cloudformation-controller
